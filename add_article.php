...
/*if(tag_verify($_POST['tags']) == 0) {
	echo ('Tags not in accordance with the rules. It is supposed to have up to 24 lower case letters (e.g. "bitcoin"). It can have a dash in 3 characters (e.g. "pl-bitcoin").');
	$error = 1;
}*/

if($error == 0) {
$save_to_file['creator'] = "fervi";
